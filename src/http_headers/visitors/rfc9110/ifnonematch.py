...
import http_headers.visitors.rfc9110.entitytag as entitytag


class IfNoneMatchVisitor(NodeVisitor):
    ...
    def visit_if_none_match(
        self, node: Node
    ) -> Literal["*"] | list[entitytag.EntityTag]:
